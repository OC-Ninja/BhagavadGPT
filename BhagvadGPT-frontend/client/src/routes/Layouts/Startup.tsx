  ...
  return (
    <AuthLayout
      header={
        headerText
          ? localize(headerText)
          : typeof headerMap[location.pathname] === 'string'
            ? (headerMap[location.pathname] as string)
            : localize(headerMap[location.pathname] as TranslationKeys)
      }
